    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderBooksId = table.Column<int>(type: "int", nullable: false),
                    OrdersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookModelOrderModel", x => new { x.OrderBooksId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_BookModelOrderModel_Books_OrderBooksId",
                        column: x => x.OrderBooksId,
